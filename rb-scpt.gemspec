...
Gem::Specification.new do |s|
  ...
  s.files = Dir["**/*"].grep_v(/^tmp/).delete_if { |name| ["MakeFile", "ae.bundle", "mkmf.log", "rbae.o", "SendThreadSafe.o", "src/osx_ruby.h", "src/osx_intern.h"].include?(name) }
  s.extensions = "ext/AE/extconf.rb"
